            ...
            for mode in verbosity_modes:
                ...
                try:
                    ...
                    raise AssertionError(
                        f"{format_name} formatter with {mode} mode failed: {e}")
        ...
        for formatter_class in [JSONFormatter, HTMLFormatter, HumanFormatter]:
            for invalid_mode in invalid_modes:
                try:
                    ...
                    raise AssertionError(
                        f"Should have rejected invalid mode: {invalid_mode}")
                except ValueError:
                ...
                try:
                    ...
                    raise AssertionError(
                        f"Should have rejected invalid mode in set_verbosity: {invalid_mode}")
                except ValueError:
                    pass  # Expected behavior
